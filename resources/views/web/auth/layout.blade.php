...
@section("content")
    <section class="relative flex items-center justify-center min-h-screen w-full">
        {{--Background Paint--}}
        <div
                class="pointer-events-none absolute inset-0 flex items-center justify-center overflow-hidden [mask-image:radial-gradient(circle_at_center,rgba(255,255,255,1)_0%,rgba(255,255,255,0)_85%)]">
            <svg
        ...
        <div
            ...
            <div class="flex items-center justify-center">
                ...
                <a href="{{ route("dashboard") }}" class="flex flex-col text-center">
